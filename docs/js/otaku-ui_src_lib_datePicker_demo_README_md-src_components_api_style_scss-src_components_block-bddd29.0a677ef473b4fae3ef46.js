...
`,
    ...
    lang: `tsx`,
    code: `ReactDOM.createRoot(container).render(<DatePicker firstWeek="一"></DatePicker>)
`
  })))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement("h2", {
...
`
  ...
  onChange?: (date: ResultDate) => void
    ...
    data: `[{"name":"DatePicker","data":[{"name":"date","type":"dayjs.ConfigType","required":false,"typeReference":null,"jsDoc":[]},{"name":"firstWeek","type":"'日' | '一'","required":false,"typeReference":null,"jsDoc":[]},{"name":"placeholder","type":"string","required":false,"defaultValue":"请选择日期","typeReference":null,"jsDoc":[]},{"name":"format","type":"string","required":false,"defaultValue":"YYYY-MM-DD","typeReference":null,"jsDoc":[]},{"name":"disabled","type":"boolean","required":false,"typeReference":null,"jsDoc":[]},{"name":"clear","type":"boolean","required":false,"typeReference":null,"jsDoc":[]},{"name":"lunarDate","type":"boolean","required":false,"typeReference":null,"jsDoc":[]},{"name":"onChange","type":"(date: ResultDate) => void","required":false,"typeReference":null,"jsDoc":[]}]}]`
...
//# sourceMappingURL=otaku-ui_src_lib_datePicker_demo_README_md-src_components_api_style_scss-src_components_block-bddd29.0a677ef473b4fae3ef46.js.map