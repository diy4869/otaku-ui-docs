"use strict";
(self["webpackChunkotaku_site"] = self["webpackChunkotaku_site"] || []).push([["otaku-ui_src_lib_upload_demo_README_md-src_components_api_style_scss-src_components_block_sty-e9777d"],{

/***/ "../otaku-ui/src/lib/upload/demo/README.md":
/*!*************************************************!*\
  !*** ../otaku-ui/src/lib/upload/demo/README.md ***!
  \*************************************************/
...
function MdReact() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement(react__WEBPACK_IMPORTED_MODULE_4__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement("div", {
    ...
    "aria-hidden": "false"
  }, "#")), " Upload"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement(site_component_codeExample_codeExample__WEBPACK_IMPORTED_MODULE_7__.CodeExample, {
    desc: ``,
    lang: `tsx`,
    example: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement(otaku_ui__WEBPACK_IMPORTED_MODULE_3__.Upload, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement(otaku_ui__WEBPACK_IMPORTED_MODULE_3__.Button, {
      type: "primary"
    }, "\u4E0A\u4F20")),
    code: `import { Upload, Button } from 'otaku-ui'
 <Upload>
...
`
    ...
    id: "%E6%8B%96%E6%8B%BD%E4%B8%8A%E4%BC%A0",
    tabIndex: "-1"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement("a", {
    className: "header-anchor",
    href: "#%E6%8B%96%E6%8B%BD%E4%B8%8A%E4%BC%A0"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement("span", {
    className: "b-anchor"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement("span", {
    "aria-hidden": "false"
  }, "#")), " \u62D6\u62FD\u4E0A\u4F20"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement("p", null, "\u62D6\u62FD\u4E0A\u4F20"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement(site_component_codeExample_codeExample__WEBPACK_IMPORTED_MODULE_7__.CodeExample, {
    desc: ``,
    lang: `tsx`,
    example: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4__.createElement(otaku_ui__WEBPACK_IMPORTED_MODULE_3__.Upload, {
      drag: true
    }),
    code: `import { Upload, Button } from 'otaku-ui'
...
`
    ...
    code: `export interface UploadProps {
  action?: string
  accept?: string
  name?: string
  ...
  beforeUpload?: (file: FileList) => boolean | Promise<boolean>
    ...
    data: `[{"name":"Upload","data":[{"name":"action","type":"string","required":false,"typeReference":null,"jsDoc":[]},{"name":"accept","type":"string","required":false,"typeReference":null,"jsDoc":[]},{"name":"name","type":"string","required":false,"defaultValue":"file","typeReference":null,"jsDoc":[]},{"name":"headers","type":"Record<string, string>","required":false,"typeReference":null,"jsDoc":[]},{"name":"methods","type":"'post' | 'put'","required":false,"defaultValue":"post","typeReference":null,"jsDoc":[]},{"name":"multiple","type":"boolean","required":false,"typeReference":null,"jsDoc":[]},{"name":"directory","type":"boolean","required":false,"typeReference":null,"jsDoc":[]},{"name":"withCredentials","type":"boolean","required":false,"typeReference":null,"jsDoc":[]},{"name":"data","type":"Record<string, any>","required":false,"typeReference":null,"jsDoc":[]},{"name":"drag","type":"boolean","required":false,"typeReference":null,"jsDoc":[]},{"name":"autoUpload","type":"boolean","required":false,"typeReference":null,"jsDoc":[]},{"name":"formData","type":"boolean","required":false,"typeReference":null,"jsDoc":[]},{"name":"limit","type":"number","required":false,"typeReference":null,"jsDoc":[]},{"name":"max","type":"number","required":false,"defaultValue":"3","typeReference":null,"jsDoc":[]},{"name":"children","type":"React.ReactNode","required":false,"typeReference":null,"jsDoc":[]},{"name":"request","type":"(file: FileList) => void","required":false,"typeReference":null,"jsDoc":[]},{"name":"onChange","type":"(file: FileList) => void","required":false,"typeReference":null,"jsDoc":[]},{"name":"onUpload","type":"(type: 'success' | 'error', result: any) => void","required":false,"typeReference":null,"jsDoc":[]},{"name":"beforeUpload","type":"(file: FileList) => boolean | Promise<boolean>","required":false,"typeReference":null,"jsDoc":[]}]}]`
...
//# sourceMappingURL=otaku-ui_src_lib_upload_demo_README_md-src_components_api_style_scss-src_components_block_sty-e9777d.678f70cdf2a90540bc5d.js.map